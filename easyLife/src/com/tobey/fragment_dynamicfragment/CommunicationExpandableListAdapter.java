...
public class CommunicationExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public CommunicationExpandableListAdapter(ExpandableListAdapter adapter, Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
    	...
    	Map Child = (Map) mWrappedAdapter.getChild(groupPosition, childPosition);
		final String mobile = (String)Child.get("phone");
